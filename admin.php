...
$link = new mysqli("h009403210.mysql", "h009403210_mysql", "v6nHFvH-"); //pass
$link->select_db("h009403210_db"); //db
...
<div class="container" id="jumbo-container">
	<div class="jumbotron" id="jumbo">
		...
		<div id="title">
			...
			<h4>The site registration is now an invite only. </h4>
			<h4>If you are lucky you might have a friend who wants to invite you.</h4>
		</div>
	</div>
	<div id="footer">
			<p><h6>Attention: we are not affiliated with <a href="https://yashsense.pub">yashsense.pub</a></h6></p>
			<p><h6>This website is not affiliated or authorized by valve or any market in any shape or form.</h6></p>
	</div>
</div>
<script>
